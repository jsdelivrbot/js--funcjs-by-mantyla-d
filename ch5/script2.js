...
console.log(maybe(just(123)).x); // Returns 123
console.log(maybeOf(plusplus)(just(123)).x); // Returns 124
console.log(maybeOf(plusplus)(none()).orElse('none')); // returns 'none'
...
console.log(maybePlusPlus(just(123)).x); // returns 124
console.log(maybePlusPlus(none()).orElse('none')); // returns none
...
console.log(strToUpper.compose(userName.set)(bob, 'robert')); // returns 'ROBERT'
...
var add = homoMorph(num, num, num)(function(a, b) {
  return a + b
});
